...
var RBLProviders = []models.RBLProvider{
	...
	{Host: "dyna.spamrats.com", Level: "Medium"},
	{Host: "noptr.spamrats.com", Level: "Medium"},
	{Host: "spam.spamrats.com", Level: "Medium"},
	...
	{Host: "hostkarma.junkemailfilter.com", Level: "Low"},
